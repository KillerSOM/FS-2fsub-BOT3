...
@bot.on_message(filters.private & filters.user(ADMINS) & ~filters.command(['start','users','broadcast','batch','genlink','stats','help','cmd', 'info', 'channel', 'fsub', 'add_fsub', 'fsub_chnl_ids', 'restart', 'delall_fsub', 'test']))
